...
path='/home/chenzirui/Desktop/home_mnt/32ant*32car_3.5GHz_40MHz_R501-1400_V1_24.4.12/'
...
for i in tqdm(range(test_num)):
    ...
    np.save(path + '/train20000/test' + '/data_local_' + str(i) + '.npy', data_local[index[i+80000]])
