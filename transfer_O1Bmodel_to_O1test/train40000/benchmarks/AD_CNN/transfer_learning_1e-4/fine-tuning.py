...
path_model='/home/chenzirui/Desktop/ALLoc/O1B/train40000/benchmarks/AD_CNN'
...
test_dataset_origin=DatasetFolder_mapping(path_test_origin+'/test')
...
test_dataset=DatasetFolder_mapping(path_test+'/test')
test_loader=torch.utils.data.DataLoader(
    test_dataset, batch_size=batch_size, shuffle=True, num_workers=4,pin_memory=True, drop_last=True)

train_dataset = DatasetFolder_mapping(path_test+'/train')
