...
**Environment requirements**: completing the experiments for the RO1 scenario requires approximately 0.7 TB of storage space, while the O2 part of the experiments requires about 2.1 TB. No other changes to the environmental requirements are needed.
